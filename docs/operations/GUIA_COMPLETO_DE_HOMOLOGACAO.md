...
8. com uma sugestão pendente, abra `/app/chat-pedro`: deve aparecer um tópico do lead com a mesma resposta proposta no Inbox, link para a conversa e ações de aprovar, ensinar ou descartar;
9. edite a resposta dentro do tópico e aprove: somente o texto editado deve ser enviado, o Inbox deve refletir o resultado e o tópico deve deixar de exigir ação;
10. gere duas sugestões para a mesma conversa: elas devem permanecer no mesmo tópico do lead, sem duplicar tópicos, e a fila só pode ser resolvida depois da última pendência.

...
- Deploy necessário: preview automática do PR #48 concluída em `gru1`; nenhum deploy de produção foi autorizado.
...
- Homologação humana final deve repetir o clique real entre as duas telas e conferir a renderização visual; o smoke HTTP autenticado e os runtime logs já confirmaram a meta técnica.

import { Bot, CheckCircle2, CircleAlert, Clock3, CornerUpLeft, Send, Sparkles, UserRound } from "lucide-react";
import Link from "next/link";

import type { Tables } from "@/lib/database.types";
import { createLearningCandidateAction, resolveExternalInterventionAction, sendInternalMessageAction } from "@/app/app/chat-interno/actions";
